...
public enum MusicControlEx {
    ...
    private Context context = PresenterAppContext.INSTANCE.getContext();

    public void init() {
        componentName = new ComponentName(context, NotificationReceiveService.class);
...
//        ((AudioManager) context.getSystemService(AUDIO_SERVICE)).registerRemoteController(remoteController);
    }
