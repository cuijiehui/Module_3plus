...
public interface PMSPCall {
     ...
     * @return 未接来电开关
     */
    boolean getMiscallSwitch();

    /**
     * 设置未接来电开关
     *
     * @param miscallSwitch 未接来电开关
     */
    void setMiscallSwitch(boolean miscallSwitch);
     ...
     * 设置未接来电震动
     *
     * @param miscallShock 未接来电震动
     */
    void setMiscallShock(int miscallShock);
